...
try:
    ...
    from scrape_tools.extractor import ExtractionResult, LinkFilterOptions

# Import the Rust extension module (built by maturin)
try:
    import _ferriscope_native as _rust_module
except ImportError:
    try:
        from . import _ferriscope_native as _rust_module
    except ImportError:
        _rust_module = None
